...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LocalDataManager *manager = [LocalDataManager sharedLocalDataManager];
    for (RegisterRequest *item in [manager fetchDataWithEntityName:@"RegisterRequest"]) {
        NSLog(@"%@ -- %@",item.user_name,item.login_pwd);
    }
